function renderProductCard(product) {
  ...
  return `
    <div class="bg-white rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-150 p-3 group">
      ...
      <button onclick='addToCart(${productJson}); event.stopPropagation();'
              class="w-full mt-2.5 bg-gray-900 text-white text-xs py-1.5 rounded-lg hover:bg-gray-700">
        Add to Cart
      </button>
    </div>
  `;
